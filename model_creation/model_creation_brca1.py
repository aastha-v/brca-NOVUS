...
#load all data
data = read_csv('brca1_pipeline.csv')
df = data.copy()
df = df.drop('ID', 1)
...
#save the model
model.save_model("model_brca1.txt")
...
plt.savefig("brca1/auc.png", dpi=600)
...
plt.xlabel('Recall')
plt.savefig("brca1/prcurve.png", dpi=600)
...
report_df.to_csv("brca1/classification_report.csv")
...
plt.savefig("brca1/confusion_matrix.png", dpi=600)
...
plt.savefig("brca1/boosted_trees.png", dpi=600)
...
plt.margins()
plt.savefig("brca1/feature_importance.png", bbox_inches='tight', dpi=600)
