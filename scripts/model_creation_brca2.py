...
outcome = read_csv("../input_folder/op_outcome_train_brca2", sep="\t")
...
#save the model
model.save_model("../model_creation/selfmodel_brca2.txt")
...
plt.savefig("../model_creation/brca2/auc.png")
...
plt.xlabel('Recall')
plt.savefig("../model_creation/brca2/prcurve.png")
...
report_df.to_csv("../model_creation/brca2/classification_report.csv")
...
plt.savefig("../model_creation/brca2/confusion_matrix.png")
...
plt.savefig("../model_creation/brca2/boosted_trees.png")
...
plt.margins()
plt.savefig("../model_creation/brca2/feature_importance.png", bbox_inches='tight')
