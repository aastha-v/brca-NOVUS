...
#read file with accurate colnames
...
model2.load_model("../scripts/model_brca2.txt")
...
df_preds.to_csv("../BRCA2/predictions_brca2.csv", index = False)
print("Predictions saved to file 'predictions_brca2.csv' at brca-NOVUS/BRCA2")
